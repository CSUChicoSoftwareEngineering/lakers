...
GBDialogAssessmentView::GBDialogAssessmentView(wxWindow *parent): wxDialog(parent, wxID_ANY, wxT("Edit Assignment(s)"), wxDefaultPosition, GB_ASSIGNMENT_DIALOGSIZE)
{
	...
	m_pModifyAssignmentListBox = new wxEditableListBox(m_pGBDialogPanel, ID_ModifyAssignmentListBox, "Modify Assignment(s)", wxPoint(10,100), wxSize(325, 355), wxEL_DEFAULT_STYLE | wxEL_NO_REORDER, "Modify Assignment(s)");
	// Connect Controller
...
GBDialogAssessmentView::GBDialogAssessmentView(wxWindow *parent, wxString CourseTitle): wxDialog(parent, wxID_ANY, wxT("Edit Assignment(s)"), wxDefaultPosition, GB_ASSIGNMENT_DIALOGSIZE){
	...
	//m_pCourseComboBox = new wxComboBox(m_pGBDialogPanel, ID_CourseDropDownListAssessment, "", wxPoint(20,40), wxSize(100, 25));
	// Create Assignment EditableListBox
	m_pModifyAssignmentListBox = new wxEditableListBox(m_pGBDialogPanel, ID_ModifyAssignmentListBox, "Modify Assignment(s)", wxPoint(10,10), wxSize(325, 450), wxEL_DEFAULT_STYLE | wxEL_NO_REORDER, "Modify Assignment(s)");
	// Connect Controller
